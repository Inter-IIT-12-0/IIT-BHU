    ...
    return (
        ...
        <main className='w-[90vw] h-[90vh] flex flex-row items-center relative p-8'>
            <div className='flex flex-col'>
                <div className='rounded-xl border border-gray-500 shadow-2xl mr-10 font-semibold p-4 ml-10 text-2xl w-72 break-words'>Hello I am <b>{domain.replace(/_/g, ' ')}</b> Ai Tool <br /> How may I help you Today ?</div>
