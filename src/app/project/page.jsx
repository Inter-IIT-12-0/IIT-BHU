...
import SampleSvg from "../../../public/Images/AIArcadeIcon.svg"
...
const Project = ({ project, isOpen, setIsOpen }) => {
    ...
    return (
        <main className="absolute right-0 top-0 z-40 transition-all duration-700 w-[100vw] h-[100vh] bg-zinc-800 bg-opacity-50">
            ...
            <div className="absolute right-0 top-0 flex flex-col h-[100vh] bg-white rounded-l-3xl">
