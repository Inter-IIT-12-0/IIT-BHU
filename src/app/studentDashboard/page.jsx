            ...
            {projects && <div className='flex flex-col w-full h-full '>
                ...
                <div className="flex flex-row w-full h-full overflow-x-hidden">
                    ...
                    <div className="flex flex-col w-full p-4 overflow-scroll overflow-y-auto overflow-x-hidden max-h-[90vh]">
                        <div style={{ backgroundColor: 'var(--material-theme-sys-light-primary, #001338)' }} className="flex justify-between w-[100%] h-52 rounded-3xl mb-3 p-12">
                            <div className="flex flex-col gap-8">
                                ...
                                <div>
                                    ...
                                    <h1 className="text-white text-sm font-semibold my-1">Unlock the university ecosystem with Trumio, bridging the university ecosystem, collaborate on real-world projects for global clients.</h1>
                                </div>
                            </div>
                            <img className="w-32 h-32" src="/Images/studsDashboard.png" alt="" />
                        </div>
                        <div className="flex flex-row gap-10">
                            ...
                            <div className="w-[27%] flex flex-col gap-5">
                                ...
                                <div className="p-6 flex flex-col gap-3 bg-white rounded-3xl shadow-lg">
                                    <h1 className="text-3xl font-bold">$ 0k</h1>
