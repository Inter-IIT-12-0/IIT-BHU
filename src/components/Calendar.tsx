          ...
          <div className="header flex justify-between border-b p-2">
            ...
            <div className="buttons">
              <button className="p-1">
                  <svg width="1em" fill="gray currentColor" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-left-circle" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="p-1">
                  <svg width="1em" fill="gray currentColor" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-right-circle"  xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
            ...
            <tbody>
              <tr className="text-center h-20">
                <td className="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 ">
                  <div className="flex flex-col h-40  xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 overflow-hidden">
