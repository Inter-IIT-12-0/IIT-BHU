...
const ChatbotCard: React.FC<CardProps> = ({isOpen}) => {
    ...
    return (
        <div className={`w-96 ${isOpen? 'w-96 h-96 opacity-100' : 'w-0 h-0 opacity-0'}  bg-gradient-to-l from-emerald-200 to-emerald-100 rounded-3xl flex flex-col items-center pb-6 absolute bottom-20 -right-9 -z-10 transition-all duration-1000`}>
