...
const SubMilestoneCard = ({ submilestone, setSelectedSubmilestone }) => {
  ...
  return (
    <main className='bg-white flex flex-col justify-center items-center absolute top-0 right-0 z-50 w-full h-full'>
      <div className='w-[100vw] flex justify-center items-center'> <span className='flex justify-center items-center rounded-full h-10 w-10 bg-black text-white cursor-pointer' onClick={() => setSelectedSubmilestone(null)}>X </span>  </div>
      <div className="container p-8">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex space-x-4">
            <p class="text-black font-Lato text-2xl font-semibold leading-normal tracking-tight underline cursor-pointer">Team Chat</p>
            <p class="text-black font-Lato text-2xl font-semibold leading-normal tracking-tight underline cursor-pointer">Show Milestone</p>
          </div>
        </div>
