            ...
            {showDomain && !showAiTools && <div className='ml-8'>
                ...
                <div className='flex flex-row w-[100%]'>
                {
                    tools.Domains && tools.Domains.map((ele, index) => { 
                        return <div key={index} className='w-[18%] h-40 mr-6 border-gray-300 rounded-lg bg-neutral-400 text-center cursor-pointer' onClick={() => {setShowAiTools(false); setDomainName(ele.name)}}>
                                {ele.name}
                        </div>
                    })
                }
            ...
            <div className='ml-8'>
                ...
                <div className='flex flex-row w-[100%]'>
                {
                    session && session.user.aiTools.map((ele, index) => { 
                        return <div key={index} className='w-[18%] h-40 mr-6 justify-around items-center border-gray-300 rounded-lg bg-neutral-400 text-center cursor-pointer flex flex-col'>
                                <h2> {ele.name} </h2>
