...
const ProfileSidebar = ({name, occupation, institute, tools, skills, professionalInto}) => {
    ...
    return (
        <div className="overflow-scroll h-[106vh] overflow-y-auto overflow-x-hidden w-72 bg-white shadow-2xl pb-10 flex flex-col z-20 pt-28">
            <div>
            <div className="justify-center items-center text-center">
                ...
                <div>
                    ...
                    <h2
                      key={index}
                      className="text-center font-Lato text-Text-Black text-1xl font-semibold">
                      {item}
                    </h2>
                  ))}
                </div>
